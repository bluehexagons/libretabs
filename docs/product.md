...
without pausing, and pausing restores keyboard focus to Play. Hiding or revealing
controls leaves the music layout unchanged; reduced motion switches without the fade.
